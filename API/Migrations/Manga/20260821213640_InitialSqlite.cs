    ...
    public partial class InitialSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Key = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    BasePath = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    LibraryName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetadataEntry = table.Column<string>(type: "TEXT", maxLength: 21, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverUrl = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    ReleaseStatus = table.Column<int>(type: "INTEGER", nullable: false),
                    LibraryId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    IgnoreChaptersBefore = table.Column<float>(type: "REAL", nullable: false),
                    DirectoryName = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    CoverFileNameInCache = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    Year = table.Column<uint>(type: "INTEGER", nullable: true),
                    OriginalLanguage = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Key = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ParentMangaId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    VolumeNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    ChapterNumber = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Key = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    LinkProvider = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Key = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ObjId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    MangaConnectorName = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    IdOnConnectorSite = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    WebsiteUrl = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    UseForDownload = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MangaTagIds = table.Column<string>(type: "TEXT", nullable: false),
                    MangaIds = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
