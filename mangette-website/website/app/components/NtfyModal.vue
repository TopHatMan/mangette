...
const requestData = ref<CreateNtfyConnectorRecord>({ name: 'Ntfy', url: '', priority: 3, username: '', password: '', topic: 'Mangette' });
...
const connect = async () => {
    try {
        await $api('/v2/NotificationConnector/Ntfy', { method: 'PUT', body: requestData.value });
